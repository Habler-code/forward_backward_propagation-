...
Using the code you wrote to classify the MNIST dataset 
...
##Train the network and produce predictions 
  ...
  The function should use the earlier functions in the following order: initialize -> L_model_forward -> compute_cost -> L_model_backward -> update parameters
